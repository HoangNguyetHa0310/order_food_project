                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="category_name_input" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" placeholder="Tên danh mục" name="category_name">
                                <div id = 'required_category_name' class="invalid-feedback">
                                    <div>Tên danh mục là bắt buộc!</div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
                            <button type="button" class="btn btn-info" id="add_category_bttn">Thêm danh mục</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="modal fade" id="<?php echo $delete_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $delete_data; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Bạn có chắc chắn muốn xóa danh mục này "<?php echo strtoupper($category['category_name']); ?>"?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
            ...
            $.ajax(
                {
                    ...
                    success: function (data)
                    {
                        ...
                        {
                            swal("Danh mục mới",data['message'], "success").then((value) => {
        ...
        $.ajax(
            {
                ...
                success: function (data)
                {
                    swal("Xóa danh mục","Danh mục đã được xóa thành công!", "success").then((value) => {
                        window.location.replace("menu_categories.php");
                    });
                },
                error: function(xhr, status, error)
