                                ...
                                <form method="POST" class="menu_form" action="users.php?do=Edit&user_id=<?php echo $user['user_id'] ?>">
                                    <div class="panel-X">
                                        ...
                                        <div class="panel-body-X">
                                            ...
                                            <div class="form-group">
                                                <label for="user_password">Mật khẩu người dùng</label>
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($_POST['edit_user_sbmt']))
                                                    {
                                                        if(!empty($_POST['user_password']) and strlen($_POST['user_password']) < 8)
                                                        {
                                                            ?>
                                                                <div class="invalid-feedback" style="display: block;">
                                                                    Độ dài mật khẩu phải ít nhất 8 ký tự.
                                                                </div>
                                                            <?php
                            ...
                            if(empty($user_password))
                            {
                                try
                                {
                                    ...
                                    ?> 
                                        ...
                                        <script type="text/javascript">
                                            swal("Chỉnh sửa người dùng","Người dùng đã được cập nhật thành công", "thành công").then((value) =>
                                            {
