                                ...
                                <div class="modal fade" id="<?php echo $delete_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $delete_data; ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Bạn có chắc chắn muốn xóa món ăn "<?php echo strtoupper($menu['menu_name']); ?>"?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
                                                <button type="button" data-id = "<?php echo $menu['menu_id']; ?>" class="btn btn-danger delete_menu_bttn">Xóa</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    elseif($do == 'Add')
    {
                    ...
                    <div class="panel-X">
                        ...
                        <div class="save-header-X">
                            <div style="display:flex">
                                ...
                                <div class="title-container">Chi tiết món ăn</div>
                            </div>
                        ...
                        <div class="panel-body-X">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo (isset($_POST['menu_name']))?htmlspecialchars($_POST['menu_name']):'' ?>" placeholder="Tên món" name="menu_name">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <label for="menu_category">Loại món</label>
                            ...
                            <div class="form-group">
                                <label for="menu_description">Mô tả món</label>
                                ...
                                if(isset($_POST['add_new_menu']))
                                {
                                    ...
                                    elseif(strlen(test_input($_POST['menu_description'])) > 200)
                                    {
                                        ?>
                                        <div class="invalid-feedback" style="display: block;">
                                            Độ dài mô tả phải nhỏ hơn 200 ký tự.
                                        </div>
                                        <?php
                            ...
                            <div class="form-group">
                                <label for="menu_price">Giá món ($)</label>
                                <input type="text" class="form-control" value="<?php echo (isset($_POST['menu_price']))?htmlspecialchars($_POST['menu_price']):'' ?>" placeholder="Giá món" name="menu_price">
                                <?php
                            ...
                            <div class="form-group">
                                <label for="menu_image">Ảnh món</label>
        ...
        if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_menu_form == 0)
        {
            ...
            try
            {
                ...
                <script type="text/javascript">
                    swal("Món ăn mới","Món ăn mới đã được thêm thành công", "success").then((value) =>
                    {
                        ...
                        <form method="POST" class="menu_form" action="menus.php?do=Edit&menu_id=<?php echo $menu['menu_id'] ?>" enctype="multipart/form-data">
                            <div class="panel-X">
                                ...
                                <div class="panel-body-X">
                                    ...
                                    <div class="form-group">
                                        <label for="menu_name">Tên món</label>
                                        <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo $menu['menu_name'] ?>" placeholder="Tên món" name="menu_name">
                                        <?php
                                    ...
                                    <div class="form-group">
                                        <label for="menu_price">Giá món ($)</label>
                                        <input type="text" class="form-control" value="<?php echo $menu['menu_price'] ?>" placeholder="Giá món" name="menu_price">
                                        <?php
                ...
                if(isset($_POST['edit_menu_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_menu_form == 0)
                {
                    ...
                    if(empty($_FILES['menu_image']['name']))
                    {
                        try
                        {
                            ...
                            <script type="text/javascript">
                                swal("Sửa món ăn","Món ăn đã được cập nhật thành công", "success").then((value) =>
                                {
                                    window.location.replace("menus.php");
                                });
                            </script>
        ...
        $.ajax(
            {
                ...
                {
                    swal("Xóa món ăn","Món ăn đã được xóa thành công!", "success").then((value) => {
                        window.location.replace("menus.php");
                    });
                },
                error: function(xhr, status, error)
                {
                    alert('ĐÃ XẢY RA LỖI KHI THỰC HIỆN YÊU CẦU CỦA BẠN');
                }
            });
    });
